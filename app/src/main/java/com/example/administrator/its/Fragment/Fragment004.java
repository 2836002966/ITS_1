...
public class Fragment004 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment004,null);
        netUntil=new NetUntil();
        lineChart = view.findViewById(R.id.chart004);
