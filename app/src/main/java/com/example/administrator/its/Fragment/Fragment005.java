...
public class Fragment005 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment005,null);
        netUntil=new NetUntil();
        lineChart = view.findViewById(R.id.chart005);
    ...
    private void setJson(String result){
        ...
        try {
            ...
            num.add((float) info.getInt("pm2.5"));
            if(num.size()==5){
                values.clear();
