...
public class BalanceService extends Service{
    ...
    public void onCreate() {
        super.onCreate();
        ip= CacheUntil.getString(this,"url","192.168.1.109");
    ...
    private Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 0:
                netUntil.getData("{\"CarId\":1}","http://192.168.1.109:8080/transportservice/type/jason/action/GetCarAccountBalance.do",handler);
